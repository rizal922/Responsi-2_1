  ...
  <div class="row">
    <div class="col-md-12">
        <div class="pd-20 card-box mb-30">
            ...
            <hr>
            <form action="<?php echo e(route('admin.manage-categories.store-category')); ?>" method="POST" enctype="multipart/form-data" class="mt-3">
                <?php echo csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="category_name" placeholder="Enter category name" value="<?php echo e(old('category_name')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('back.layout.pages-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GearGamers_Ecommerce\resources\views/back/pages/admin/add-category.blade.php ENDPATH**/ ?>