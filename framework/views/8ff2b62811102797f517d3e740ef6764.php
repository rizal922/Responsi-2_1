...
[$__name, $__params] = $__split('admin-seller-header-profile-info');

$__html = app('livewire')->mount($__name, $__params, 'lw-3798701183-0', $__slots ?? [], get_defined_vars());
...
?>
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li>
							<a href="<?php echo e(route('admin.manage-categories.cats-subcats-list')); ?>" class="dropdown-toggle no-arrow <?php echo e(Route::is('admin.manage-categories.*') ? 'active' : ''); ?>">
						...
						<?php else: ?>
						<li>
							<a href="<?php echo e(route('seller.home')); ?>" class="dropdown-toggle no-arrow <?php echo e(Route::is('seller.home') ? 'active' : ''); ?>">
								<span class="micon fa fa-home"></span
								><span class="mtext">Home</span>
							</a>
						</li>
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle <?php echo e(Route::is('seller.product.*') ? 'active' : ''); ?>">
								<span class="micon bi bi-bag"></span><span class="mtext">Manage Products</span>
							</a>
							<ul class="submenu">
								<li><a href="<?php echo e(route('seller.product.all-products')); ?>" class="<?php echo e(Route::is('seller.product.all-products') ? 'active' : ''); ?>">All Products</a></li>
								<li><a href="<?php echo e(route('seller.product.add-product')); ?>" class="<?php echo e(Route::is('seller.product.add-product') ? 'active' : ''); ?>">Add Product</a></li>
							</ul>
						</li>
						...
						<li>
							<a
								href="<?php echo e(route('seller.profile')); ?>"
								
								class="dropdown-toggle no-arrow <?php echo e(Route::is('seller.profile') ? 'active' : ''); ?>"
							>
								<span class="micon fa fa-user"></span>
								<span class="mtext"
									>Profile
	...
	<li>
							<a
								href="<?php echo e(route('seller.shop-settings')); ?>"
								
								class="dropdown-toggle no-arrow <?php echo e(Route::is('seller.shop-settings') ? 'active' : ''); ?>"
							>
...
<?php /**PATH C:\xampp\htdocs\GearGamers_Ecommerce\resources\views/back/layout/pages-layout.blade.php ENDPATH**/ ?>